...
import { readJsonSync, outputFile, copySync, outputJSON, pathExistsSync, copy, ensureDir, removeSync, existsSync, readFileSync, readJSONSync, outputJSONSync } from 'fs-extra';
...
const cli = () => {
  return command('init', 'initialize docz in your app', setArgs, async args => {
    ...
    await serve(args);
    process.exit();
  }).demandCommand().help().wrap(72).epilog('for more information visit https://github.com/doczjs/docz').showHelpOnFail(false, 'whoops, something went wrong! run with --help').argv;
};
